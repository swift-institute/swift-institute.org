...
Moving [API-IMPL-015] to Implementation.md
...
| Implementation | C shims, platform conditionals | 18 | 3,800 | 2026-01-16 |

Cross-reference graph:
- API-Requirements → Primitives-Architecture (12 refs)
- Primitives-Architecture → API-Requirements (8 refs)
- Implementation → API-Requirements (5 refs)
```
...
Documents: API-Requirements, Primitives-Architecture, Implementation
...
- Recommendation: Move to Implementation.md
```
...
| Implementation | C-Shims, Platform-Compilation, Swift-6, Anti-Patterns |
| Memory | Memory-Ownership, Memory-Copyable, Memory-Safety, Memory-Reference |
| Primitives Architecture | Primitives-Tiers, Primitives-Layering, Primitives-Requirements (in swift-primitives) |
...
Result:
- Primitives-Tiers.md (Definition) → now in swift-primitives
- Primitives-Layering.md (Decision) → now in swift-primitives
- Primitives-Requirements.md (Policy) → now in swift-primitives
...
1. MOVE [API-IMPL-015] from API-Requirements.md to Implementation.md
...
**Correct**:
```
Move [API-IMPL-015] to Implementation.md

Steps performed:
1. Copied [API-IMPL-015] to Implementation.md under "Platform Patterns" section
...
5. Verified: grep for [API-IMPL-015] shows only Implementation.md

Commit: Move [API-IMPL-015] to Implementation.md
```
...
1. Copied content to Implementation.md
...
- Primitives-Requirements.md [PRIM-FOUND-001] (4 paragraphs) — in swift-primitives
- Anti-Patterns.md [PATTERN-009] (2 paragraphs)

Action:
1. Canonical location: Primitives-Requirements.md [PRIM-FOUND-001] (swift-primitives)
2. API-Requirements.md: Replace with "See [PRIM-FOUND-001]"
3. Anti-Patterns.md: Replace with "See [PRIM-FOUND-001]"
