...
**File**: `https://github.com/swift-primitives/swift-path-primitives/blob/main/Sources/Path Primitives/Path.String.swift`
...
```bash
cd Experiments/rendering-context-protocol-vs-witness/Tests
rm -rf .build
...
**swift-testing location**: `https://github.com/swift-foundations/swift-testing`

Search for:
```bash
grep -rn "PERFORMANCE_DIAGNOSTIC" \
  https://github.com/swift-foundations/swift-testing \
  --include="*.swift"
```
...
| File | Contains |
|------|----------|
| `https://github.com/swift-primitives/swift-path-primitives/blob/main/Sources/Path Primitives/Path.String.swift` | Crashing `defer { for buffer in unsafe ... }` pattern (lines 562–579) |

### swift-testing

| File | Contains |
|------|----------|
| `https://github.com/swift-foundations/swift-testing` | Root of swift-testing package |
...
| File | Contains |
|------|----------|
| `Experiments/rendering-context-protocol-vs-witness/Tests/Performance Tests/RenderingDispatchPerformanceTests.swift` | Test file that demonstrates all three swift-testing issues |
| `Experiments/rendering-context-protocol-vs-witness/Sources/Benchmark/main.swift` | Ad-hoc benchmark that the swift-testing fixes should make unnecessary |
...
| Package | Path |
|---------|------|
| swift-primitives (monorepo) | `https://github.com/swift-primitives` |
...
| swift-institute | `./` |
| Experiment (reference) | `Experiments/rendering-context-protocol-vs-witness/` |
